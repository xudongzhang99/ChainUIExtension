...
public extension String {
    ...
    func Strikethrough() -> NSMutableAttributedString {
        let attributedText = NSMutableAttributedString(string: self, attributes: [.strikethroughStyle: NSUnderlineStyle.styleSingle.rawValue])
        return attributedText
    }
}
...
public extension NSMutableAttributedString {
    ...
    func Strikethrough() -> Self {
        ...
        addAttributes([.strikethroughStyle: NSUnderlineStyle.styleSingle.rawValue], range: range)
        return self
    }
